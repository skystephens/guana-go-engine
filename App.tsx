...
import InteractiveMap from './pages/b2c/InteractiveMap';
import MapView from './pages/catalog/MapView';
import POIDetail from './pages/b2c/POIDetail';

// B2C User Pages
import Wallet from './pages/b2c-user/Wallet';
import AccountDashboard from './pages/b2c-user/AccountDashboard';

// Checkout Pages
import MyItinerary from './pages/checkout/MyItinerary';
...
// List Pages
import TourList from './pages/b2c/TourList';
import HotelList from './pages/b2c/HotelList';
import TaxiList from './pages/b2c/TaxiList';
import PackageList from './pages/b2c/PackageList';

// Flow Pages
import Reviews from './pages/b2c/Reviews';
...
const App: React.FC = () => {
  ...
  const renderScreen = () => {
    switch (currentRoute) {
      ...
      case AppRoute.SAN_ANDRES_MAP: return <MapView onSelectPOI={(poi) => navigateTo(AppRoute.POI_DETAIL, poi)} />;
      case AppRoute.POI_DETAIL: return <POIDetail poi={detailData} onBack={goBack} onNavigate={navigateTo} />;
