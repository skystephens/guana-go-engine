...
import { Bell, Briefcase, Map as MapIcon, Car, MessageCircle } from 'lucide-react';
...
const Dashboard: React.FC<DashboardProps> = ({ onNavigate }) => {
  ...
  // Mock Admin User for the Chat Window
  const adminUser = {
     id: 'admin',
     name: 'Soporte Admin',
     role: 'admin',
     image: 'https://ui-avatars.com/api/?name=Admin+Support&background=10B981&color=fff'
  };
    ...
    <div className="bg-gray-900 min-h-screen text-white pb-24 font-sans relative">
      ...
      <header className="px-6 pt-12 pb-6 flex justify-between items-center bg-gray-900">
         ...
         <div className="flex gap-2">
            <button 
               ...
               className="relative p-2 bg-gray-800 rounded-full hover:bg-gray-700 transition-colors text-green-500"
      ...
      {showSupportChat && (
         <ChatWindow 
            ...
            currentUserId="partner-1" // Hardcoded current partner
